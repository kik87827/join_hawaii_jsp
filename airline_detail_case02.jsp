                                ...
                                <div class="fsx_vcontlow">
                                    <div class="fsx_form">
                                        <a href="javascript:;" class="btn_formtarget type6" id="fmen_target"
                                            ...
                                            <div class="formtarget_in ellips result_initem">성인2명 아동1명</div>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="sub_contents_wrap">
                ...
                <div class="sc_dcont_zone">
                    <div class="sc_dcont" id="sc_dcont01">
                        <div class="sc_dcont_npara neqtop">
                                    ...
                                    <div class="sc_datatb_wrap pc_only airdetail_fee_tb">
                                        <table class="sc_datatb">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th class="sig_th"><span class="sc_hordata_text">합계</span></th>
                                                    <td colspan="3"><span class="sc_hordata_text total_sym">\2,910,000 (TAX 및 수수료 포함)</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="mb_price_guide_wrap mobile_only">
                                        <div class="mvprice_vitem">
                                            <div class="mb_both_spec_dl_w type2">
                                                ...
                                                <div class="mb_both_spec_dl total_row">
                                                    <div class="mv_bspec_cell has_bth"><span class="mv_bth">합계</span></div>
                                                    <div class="mv_bspec_cell has_btd"><span class="mv_btd">\2,910,000 (TAX 및 수수료 포함)</span></div>
                                                </div>
                                            </div>
