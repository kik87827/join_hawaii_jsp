...
<body class="front_body">
    <div class="page_wrap">
        ...
        <section class="mid_section">
            ...
            <div class="sub_visual_wrap bg_airline">
                ...
                <div class="sv_form_wrap">
                    <fieldset class="form_search_field_wrap case02">
                        <legend>검색</legend>
        ...
        <!-- layer -->
        <div class="poslayer_z widtype4" id="startpos_choice_layer_01">
            <div class="poslayer_titlow">
        ...
        <!-- layer -->
        <div class="poslayer_z widtype4" id="endpos_choice_layer_01">
            <div class="poslayer_titlow">
