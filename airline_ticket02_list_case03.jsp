...
<body class="front_body">
    <div class="page_wrap">
        ...
        <section class="mid_section">
            ...
            <div class="sub_visual_wrap bg_airline">
                ...
                <div class="sv_form_wrap">
                    <fieldset class="form_search_field_wrap case02 addmode">
                        <legend>검색</legend>
                        <div class="fsinitem_fxwrap">
                            ...
                            <div class="fsinitem_fxcell has_startpos2">
                                ...
                                <div class="fsx_vcontlow type2">
                                    ...
                                    <div class="fsx_form">
                                        <a href="javascript:;" class="btn_formtarget" id="startpos_target_02" data-poslayer="#startpos_choice_layer_02">
                                            <div class="formtarget_in ellips qus_initem">선택</div>
                                            <div class="formtarget_in ellips result_initem">오아후/호놀룰루</div>
                                        </a>
                                    </div>
                            ...
                            <div class="fsinitem_fxcell has_endpos2">
                                ...
                                <div class="fsx_vcontlow type2">
                                    ...
                                    <div class="fsx_form">
                                        <a href="javascript:;" class="btn_formtarget" id="endpos_target_02" data-poslayer="#endpos_choice_layer_02">
                                            <div class="formtarget_in ellips qus_initem">선택</div>
                                            <div class="formtarget_in ellips result_initem">빅아일랜드/힐로</div>
                                        </a>
                                    </div>
        ...
        <div class="poslayer_z widtype4 startpos_choice_layer" id="startpos_choice_layer_02">
            <div class="poslayer_titlow">
                <p class="poslayer_tit">출발지를 선택하세요</p>
            </div>
            <div class="poslayer_contlow">
        ...
        <div class="poslayer_z widtype4 endpos_choice_layer" id="endpos_choice_layer_02">
            <div class="poslayer_titlow">
                <p class="poslayer_tit">도착지를 선택하세요</p>
            </div>
            <div class="poslayer_contlow">
