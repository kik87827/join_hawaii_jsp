                                                ...
                                                <div class="resui_cell resui_td">
                                                    ...
                                                    <div class="data_ctb_wrap type2 pc_only choice_tourist_fee_tb">
                                                        <table class="data_ctb dtype2">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td><span class="data_ctd_text">공항픽업 / 샌딩(합류)</span></td>
                                                                    <td>
                                                                        <div class="data_cvlist">
                                                                            <div class="dsta_cvitem"><span class="data_ctd_text">성인(만12세이상) $30 * 1명</span></div>
                                                                            <div class="dsta_cvitem"><span class="data_ctd_text">소아(만 0~17세) $30 * 1명</span></div>
                                                                            <div class="dsta_cvitem"><span class="data_ctd_text">유아(만02세미만) $0  * 0명</span></div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="data_cvtotal_siglow">합계 : <span class="cvsig_sym">$60</span></div>
                                                                        <div class="data_cvtotal_sublow">TAX및 수수료포함</div>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <div class="mb_price_guide_wrap mobile_only">
                                                        <div class="mvprice_vitem">
                                                            ...
                                                            <div class="mb_both_vspec_w">
                                                                <div class="mb_both_vspec">성인(만12세이상) $30 * 1명</div>
                                                                <div class="mb_both_vspec">소아(만 0~17세) $30 * 1명</div>
                                                                <div class="mb_both_vspec">유아(만02세미만) $0  * 0명</div>
                                                            </div>
