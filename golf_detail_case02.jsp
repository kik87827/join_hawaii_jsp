                                                            ...
                                                            <table class="data_ctb dtype2">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="data_cprice_vitem">
                                                                                <div class="data_price_sub2">$180 * 3명 =</div>
                                                                                <div class="data_csym_price2">$180</div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="data_cprice_vitem">
                                                                                <div class="data_price_sub2">$150 * 3명 =</div>
                                                                                <div class="data_csym_price2">$150</div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="btn_thvsm_w"><a href="#" class="btn_thvsm">예약</a></div>
                                                                ...
                                                                <div class="mb_bgroup_wrap">
                                                                    <div class="mb_bgroup">
                                                                        <div class="mb_both_spec_dl_w">
                                                                            <div class="mb_both_spec_dl avtype2">
                                                                                <div class="mv_bspec_cell has_bth"><span class="mv_bth">픽업포함</span></div>
                                                                                <div class="mv_bspec_cell has_btd">
                                                                                    <div class="mv_btd bold_med">$180 * 3명 = <span class="mv_btd_insym">$180</span></div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="mb_bgroup">
                                                                        <div class="mb_both_spec_dl_w">
                                                                            <div class="mb_both_spec_dl avtype2">
                                                                                ...
                                                                                <div class="mv_bspec_cell has_btd">
                                                                                    <div class="mv_btd bold_med">$150 * 3명 = <span class="mv_btd_insym">$150</span></div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="btn_mvguide_submit_wrap">
