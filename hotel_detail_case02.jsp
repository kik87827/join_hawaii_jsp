                                ...
                                <div class="fsx_vcontlow fsx_chkinut_fxwrap">
                                    <div class="fdx_chkinput_fxcell has_input">
                                        <div class="btn_formtarget type2">
                                            <!-- 211104 수정 -->
                                            <input type="text" name="daterange" placeholder="선택하세요" class="formtarget_input">
                                        </div>
                                    </div>
            ...
            <div class="sub_contents_wrap">
                ...
                <div class="sc_dcont_zone">
                    <div class="sc_dcont" id="sc_dcont01">
                        <div class="sc_dtitlow type2"><h4 class="sc_dtit">객실 요금</h4></div>
                        <div class="sc_dcontlow">
                            <div class="tailthum_hvitem_group_zone"> 
                                <div class="tailthum_hvitem_group">
                                    <div class="tailthum_hvg_titlow">객실 1</div>
                                    <div class="tailthum_hvg_contlow">
                                ...
                                <div class="tailthum_hvitem_group">
                                    <div class="tailthum_hvg_titlow">객실 2</div>
                                    <div class="tailthum_hvg_contlow">
                                        <div class="tailthum_hvitem_w">
                                            <!-- tailthum_hvitem -->
                                            <div class="tailthum_hvitem">
                                                ...
                                                <div class="mobile_only mvprice_vitem_nw">
                                                    <div class="mvprice_vitem">
                                                        <div class="mb_both_spec_dl_w">
                                                            ...
                                                            <div class="mb_both_spec_dl">
                                                                <div class="mv_bspec_cell has_bth"><span class="mv_bth"><span class="vishidden">추가요금 -
                                                                        </span>인원추가</span></div>
                                                                <div class="mv_bspec_cell has_btd"><span class="mv_btd">$0</span></div>
                                                            </div>
                                                            <div class="mb_both_spec_dl">
