...
<body class="front_body">
    <div class="page_wrap">
        ...
        <script>
            $(function () {
                $("#btn_guide_call").on("click", function () {
                    dimLayerShow({
                        target: "#cart_03_reservation_choose_identify"
                    });
                });
                dimLayerShow({
                    target: "#cart_03_reservation_choose_identify"
        ...
        <!-- layer -->
        <div class="dimlayer_z" id="cart_03_reservation_choose_identify">
                ...
                <div class="dimlayer_td">
                    <div class="layer_box dtype2 sztype6">
                        ...
                        <div class="layer_box_btnlow">
                            <a href="#" class="btn_layersm type2 closetrigger">예약확인서 확인</a> <!-- closetrigger 닫기 트리거 -->
                        </div>
