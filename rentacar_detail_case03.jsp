                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="data_cprice_vitem">
                                                                            <div class="data_price_sub">$450(주간요금기준) * 1주 = <span class="data_csym_price">$450</span></span></div>
                                                                        </div>
                                                                        <div class="data_cprice_vitem">
                                                                            <div class="data_price_sub">$120(24시간기준) * 3일 = <span class="data_csym_price">$360</span></span></div>
                                                                        </div>
                                                                        <div class="data_cprice_vitem has_total">
                                                                            <div class="data_csym_price">합계 : $810</div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
