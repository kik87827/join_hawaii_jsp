   ...
   <div class="list_w">
		<table class="codinglist">
			...
			<tbody>
				...
				<tr>
					<td class="no"></td>
					<td class="link"><a href="hotel_confirmation.jsp" target="_blank">HOTEL CONFIRMATION</a></td>
					<td class="td_url"></td>
				...
				<tr>
					<td class="no"></td>
					<td class="link"><a href="tour_voucher.jsp" target="_blank">TOUR VOUCHER</a></td>
					<td class="td_url"></td>
					<td class="work end"></td>
					<td class="bgo"></td>
				</tr>
				<tr>
					<td class="no"></td>
					<td class="link"><a href="golf_voucher.jsp" target="_blank">GOLF VOUCHER</a></td>
					<td class="td_url"></td>
					<td class="work end"></td>
					<td class="bgo"></td>
				</tr>
				<tr>
					<td class="no"></td>
					<td class="link"><a href="rent_voucher.jsp" target="_blank">RENT A CAR VOUCHER</a></td>
					<td class="td_url"></td>
					<td class="work end"></td>
					<td class="bgo"></td>
				</tr>
